...
function renderNotes() {
    ...
    if (notes.length === 0) {
        ...
        notes.forEach(n => {
            ...
            const dayPasaranDiv = document.createElement("div");
            dayPasaranDiv.classList.add("note-day-pasaran");
            dayPasaranDiv.innerText = `${getDayName(dateObj)} - ${getPasaranJawa(dateObj)}`;
